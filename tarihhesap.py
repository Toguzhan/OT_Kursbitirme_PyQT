...
class Window(QMainWindow):
	...
	def __init__(self):
		...
		# setting title
		self.setWindowTitle("Tarih hesaplayıcı")
	...
	def UiComponents(self):
		...
		# creating head label
		head = QLabel("Tarih Hesaplayıcı", self)
		...
		dob.setFont(QFont('Calibri', 10))

		# given date label
		given = QLabel("Son Tarih", self)
	...
	def find_age(self):
		...
		self.result.setText(str(calculated_day) + " Gün, " + str(calculated_month)
                      + " Ay, " + str(calculated_year) + " Yıl")
